  ...
  const mainCategories = [
    {
      name: "Nike T-Shirts",
      subcategories: [
        "Nike V-Neck T-Shirts",
        "Nike Pocket T-Shirts",
        "Nike Tie Dye Shirts",
        "Nike Baseball Tees",
        "Nike Shirts Made in the USA",
        "Nike Sustainable T-Shirts",
        "Nike Crop Tops",
        "Nike Ringer Tees",
        "Nike Long Sleeve T-Shirts",
        "Nike Heavyweight T-Shirts",
        "Nike Safety Shirts",
        "Nike Budget-Friendly T-Shirts",
        "Nike Premium T-Shirts",
        "Nike New T-Shirts",
        "All Nike T-Shirts",
      ],
    },

    { name: "Nike Polo Shirts", subcategories: [
      "Nike Printed Polo Shirts",
      "Nike Sustainable Polos",
      "Nike New Polos",
      "Nike Budget-Friendly Polos",
      "Nike Premium Polos",
      "All Nike Polo Shirts",
      "Nike Women's Polo Shirts",
      "Nike Kids Polo Shirts",
      "Nike Tall Polos"
    ]},
    { name: "Nike Caps", subcategories: [
      "Nike Snapback Hats",
      "Nike Dad Hats",
      "Nike 5-Panel Hats",
      "Nike Performance Hats",
      "Nike Visors",
      "Nike Rope Hats",
      "Nike Budget-Friendly Hats",
      "Nike Premium Hats",
      "Nike Golf Hats",
      "Nike Kids Hats",
      "Nike Embroidered Hats",
      "Nike Fitted Hats",
      "Nike Flat Bill Hats",
      "Nike Safety Hats",
      "Nike Camouflage Hats",
      "Nike Buckle Hats",
      "Nike Headbands",
      "Nike Bandanas",
      "Nike New Hats",
    ...
    { name: "Nike Bags", subcategories: [] },
    { name: "Nike Golf Wear", subcategories: [] },
    { name: "Nike Accessories", subcategories: [] },
    { name: "Nike New Products", subcategories: [] },
    { name: "Nike Activewear", subcategories: [] },
    { name: "Nike Pant & shorts", subcategories: [] },
    { name: "Nike Athleisure Wear", subcategories: [] },
    { name: "Nike Safety", subcategories: [] },
    { name: "Nike Kids wear", subcategories: [] },
  ];
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-5">
              {categoriess.map((category) => {
                ...
                return (
                    <Link   key={category.id} href="/brands/nike/tshirts">
                  <Card
