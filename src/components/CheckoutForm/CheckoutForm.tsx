...
const CheckoutForm = () => {
  ...
  const paymentMethods = [
    ...
    },
    {
      id: "afterpay",
      name: "Afterpay",
      icon: <SiAfterpay className="w-5 h-5" />,
    },
    {
      id: "bank",
      name: "Bank",
  ...
  return (
    <div className="max-w-[1000px] w-full py-8 space-y-6 min-h-screen">
                      ...
                      <div className="relative">
                        ...
                        <div className="absolute right-3 top-1 flex space-x-1">
                          ...
                          >
                            ...
                            ></circle>
                            <path
                              d="M24 6a10 10 0 0 0 0 20 10 10 0 0 0 0-20z"
                              fill="#FF5F00"
                            ></path>
                          </svg>
                        </div>
      ...
      {/* Pay Now Button */}
        ...
        <Button
          variant="blue"
          className="w-full sm:w-auto min-w-[200px] lg:min-w-[350px] py-3 text-lg rounded-md"
        >
          PAY NOW
        </Button>
      </div>
